...
/**
  ...
  */
void clearAllClock(){
	HAL_GPIO_WritePin ( GPIOA , LED_1_Pin | LED_2_Pin | LED_3_Pin |
...
void setNumberOnClock(int num){
	...
	case 11:
			HAL_GPIO_WritePin(LED_12_GPIO_Port, LED_12_Pin, SET);
	break;
	default:HAL_GPIO_WritePin ( GPIOA , LED_1_Pin | LED_2_Pin | LED_3_Pin |
			LED_4_Pin | LED_5_Pin | LED_6_Pin | LED_7_Pin | LED_8_Pin |
			LED_9_Pin | LED_10_Pin | LED_11_Pin | LED_12_Pin , RESET) ;
	break;
	}
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, SEG_0_Pin|SEG_1_Pin|SEG_2_Pin|SEG_10_Pin
                          |SEG_11_Pin|SEG_12_Pin|SEG_13_Pin|SEG_6_Pin
                          |SEG_5_Pin|SEG_4_Pin|SEG_3_Pin|SEG_7_Pin
